      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div className="flex gap-4">
            <div>
              ...
              <input
                ...
                className="w-12 h-10 rounded cursor-pointer border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700"
              />
            </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              className="flex-1 py-2 px-4 bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 font-medium flex items-center justify-center gap-2"
            >
              <Plus size={18} />
              Add Account
            </button>
