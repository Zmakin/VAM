    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 flex items-center justify-between p-4 border-b bg-white">
          <h2 className="text-lg font-semibold text-gray-900">Set Up Transfer</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Transfer Type */}
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-3">Transfer Type</label>
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                One-Time
                <div className="text-xs text-gray-500 mt-1">Execute once on a specific date</div>
              </button>
              <button
                type="button"
              ...
              >
                Recurring
                <div className="text-xs text-gray-500 mt-1">Automatic transfers on a schedule</div>
              </button>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <label htmlFor="indefinite" className="text-sm text-gray-700 cursor-pointer">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="cursor-pointer"
                    />
                    <label htmlFor="until" className="text-sm text-gray-700 cursor-pointer">
                      Until:
                    </label>
                    <input
                      type="date"
                      ...
                      className="flex-1 px-3 py-1 border border-gray-300 rounded-lg text-sm disabled:bg-gray-50 disabled:text-gray-400"
